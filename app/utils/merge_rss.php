...
/*
* Code from https://github.com/uniphil/merge-rss-php
*/
...
class MergeRSS {
    ...
    protected function find_xml_from($searches, $xml) {
    ...
    public function merge_rss($xmls) {
        ...
        foreach ($xmls as $feed) {
            $things = $this->find_xml_from(array(
                array("channel", "item"),
                array("entry"),
            ), $feed);
        ...
        usort($items, function($a, $b) {
            return $this->get_item_date($b) - $this->get_item_date($a);
        });
